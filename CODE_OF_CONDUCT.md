...
# Contributor Covenant Code of Conduct for the mocha-error-reporters project

Contributors to repositories hosted in mocha-error-reporters are expected to follow the Contributor Covenant Code of Conduct, and those working within City of Montreal are also expected to follow the Code of Conduct for the City of Montreal Employees 
...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported by contacting the project team at mocha.error.reporters@montreal.ca.
...
# Code de conduite pour le projet mocha-error-reporters project

Les contributeurs aux dépôts hébergés dans mocha-error-reporters project sont tenus de respecter le Code de conduite du Pacte des contributeurs, et ceux qui travaillent au sein de la Ville de Montréal sont également tenus de respecter le Code de conduite des employés de la Ville de Montréal.
...
Les cas de comportement abusif, de harcèlement ou d'autres comportements inacceptables peuvent être rapportés en communiquant avec l'équipe de projet à l'adresse suivante: mocha.error.reporters@montreal.ca.
